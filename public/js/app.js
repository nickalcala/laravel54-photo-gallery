...
$(function () {
    if ($('.photos-index-page').length > 0) {
        ...
        window.onscroll = function () {
            if (window.innerHeight + window.pageYOffset >= document.body.offsetHeight && photosPageLoadResponse.current_page + 1 <= photosPageLoadResponse.last_page && photosPageLoading == false) {
                photosPageLoad();
            }
        };
    }
...
function photosPageLoad() {
    ...
    if (!photosPageLoading) photosWrapper.append('<h3 class="photos-loading text-center">Loading</h3>');
